    ...
    return (
      <div className="notes-view">
        {viewType === 'notes' && (
          <>
            {/* AI Features Section */}
            {showAIFeatures && renderAIFeatures()}
            ...
            <div className="add-note-container">
              ...
              <div className="note-options">
                ...
                <button
                  ...
                  style={{
                    background: showAIFeatures ? '#8b5cf6' : '#f3f4f6',
                    color: showAIFeatures ? 'white' : '#374151',
                    border: 'none',
                    padding: '8px 16px',
                    borderRadius: '6px',
                    cursor: 'pointer',
    ...
    <div className={`app-container ${isSidebarOpen ? 'sidebar-open' : ''}`}>
      ...
      <div className={`sidebar ${isSidebarOpen ? 'open' : ''}`}>
        ...
        <div className="promotion-banner">
          <div className="promotion-title">Premium Features</div>
          <div className="promotion-subtitle">AI-powered note generation & more!</div>
        ...
        <nav className="sidebar-nav">
          ...
          >
            <span className="nav-item-icon">📄</span> All Notes
          </button>
          <button
            className={`nav-item ${currentView === 'favorites' ? 'active' : ''}`}
            onClick={() => setCurrentView('favorites')}
          >
            <span className="nav-item-icon">⭐</span> Favorites
          </button>
          <button
            className={`nav-item ${currentView === 'calendar' ? 'active' : ''}`}
            onClick={() => setCurrentView('calendar')}
          >
            <span className="nav-item-icon">📅</span> Calendar
          </button>
          <button
      ...
      {/* Floating Add Button */}
      {currentView === 'notes' && !showAIFeatures && (
        <button
